    ...
    <>
      <div className="HomePage-Background">
        ...
        <div className="foot-text">
          Pick it up and hit the road. Let us plan your next trip to Cancun or
          anywhere in Mexico!
        </div>
        ...
        <footer className="flex flex-col  items-center justify-around w-full py-16 text-sm text-gray-800/70">
          <div className="flex items-center gap-8">
            <a
              href="#"
              className="font-medium text-white-500 hover:text-white transition-all"
            >
              Services
            </a>
            <a
              href="localhost:5173/About"
              className="font-medium text-white-500 hover:text-white transition-all"
            >
              Contact
            </a>
          ...
          <p className="mt-8 text-center">
            {" "}
            Copyright © 2025 <a href="localhost:5173">MEXtour</a>. All rights
            reservered.
          </p>
        </footer>
      </div>
